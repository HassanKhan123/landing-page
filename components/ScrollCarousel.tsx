...
const ScrollCarousel = () => {
  ...
  return (
    ...
    >
      <div className='flex-shipping-container'>
        <div className='flex-shipping-item p-4 max-w-md'>
          <div className='shipping-card shipping-card-1'>
            ...
            <p className='text-dark-4 text-sm uppercase my-6'>
              From basic limit orders to advanced icebergs, Elektrik redefines
              the on-chain swap experience by giving users access to features
        ...
        <div className='flex-shipping-item p-4 max-w-md'>
          <div className='shipping-card shipping-card-2'>
            ...
            <p className='text-dark-4 text-sm uppercase my-6'>
              Elektrik enables its users to treat spot swaps and limit orders in
              the familiar derivative format; tracking PnL, average entry, as
              well as a visualization of resting orders on the chart.
            </p>
            <Image
        ...
        <div className='flex-shipping-item p-4 max-w-md'>
          <div className='shipping-card shipping-card-3'>
            ...
            <p className='text-dark-4 text-sm uppercase my-6'>
              Elektrik's design focuses on minimizing costs and slippage,
              providing traders with a capital-efficient platform to maximize
              their trading performance and profits.
            </p>
            <Image
